...
var ExerciseCarousel = React.createClass({
  ...
  propTypes: { 
    ...
    var exercises = {
      1: <Exercise1 default={this.props.data.exercise_1.mystring}/>,
      2: <Exercise2 first_hash={this.props.data.exercise_2.first_hash} 
                    second_hash={this.props.data.exercise_2.second_hash}
                    prettyJSON={this.props.prettyJSON}/>,
      3: <Exercise3 numbers={e3_numbers}/>,
      4: <Exercise4 list1={this.props.data.exercise_4.list1} list2={this.props.data.exercise_4.list2}/>,
      5: <Exercise5 default={this.props.data.exercise_5.default}/>
    };
    ...
    return (
      <div>
        <div style={defaultstyle}>
          ...
          <span style={headerstyle}><a href={url} target="_blank">{this.props.ex_header}</a></span>

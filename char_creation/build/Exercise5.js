...
var Exercise5 = React.createClass({
  ...
  swap: function swap(myarray, x, y) {
    var temp = myarray[x];
    myarray[x] = myarray[y];
    myarray[y] = temp;
    return myarray;
  ...
  getPermutations: function getPermutations(myarray, size) {
    if (size == 1) {
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement('textarea', { style: textstyle, value: this.state.mystr, onChange: function onChange(event) {
